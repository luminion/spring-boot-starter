...
// "h2 {color: #D32F2F; border-bottom: 2px solid #f2f2f2; padding-bottom:
// 10px;}" +
// "table {border-collapse: collapse; width: 100%; margin-top: 20px; border: 1px
// solid #ddd;}" +
// "th, td {text-align: left; padding: 12px; border-bottom: 1px solid #ddd;}" +
// "th {background-color: #f8f8f8; font-weight: bold; width: 120px;}" +
// "pre {white-space: pre-wrap; word-wrap: break-word; background-color:
// #f5f5f5; padding: 15px; border-radius: 4px; border: 1px solid #ccc;
