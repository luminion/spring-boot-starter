package io.github.luminion.starter.support.log.aspect;

import io.github.luminion.starter.support.log.spi.LogWriter;
...
public class LogAspect {
    ...
    @Pointcut("@annotation(io.github.luminion.starter.support.log.annotation.Log)")
