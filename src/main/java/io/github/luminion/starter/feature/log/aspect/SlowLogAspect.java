...
import io.github.luminion.starter.feature.log.SlowLogWriter;
import io.github.luminion.starter.feature.log.annotation.SlowLog;
...
public class SlowLogAspect {
    ...
    @Around("@within(io.github.luminion.starter.feature.log.annotation.SlowLog) " +
            "|| @annotation(io.github.luminion.starter.feature.log.annotation.SlowLog)")
