...
/**
 * 提前导入 Spring Boot 2 的 Redis 连接工厂配置，使 Velo 模板配置能够在官方模板配置之前看到连接工厂。
 *
 * @author luminion
 * @since 1.3.1
 */
public class VeloBoot2RedisConnectionConfigurationImportSelector implements ImportSelector {
